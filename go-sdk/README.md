...
```bash
go get github.com/17673651504/devspace-devbridge/go-sdk@v0.1.0
```
...
完整的类型与方法文档见 [pkg.go.dev](https://pkg.go.dev/github.com/17673651504/devspace-devbridge/go-sdk)。
